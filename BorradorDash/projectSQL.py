...
def cuarto():
    return """SELECT vt.vehicle_type, count(vt.vehicle_type) as vtQuantity, d.vehicle_damage, count(d.vehicle_damage) as dQuantity
...
GROUP BY vt.vehicle_type, d.vehicle_damage
ORDER BY vtQuantity, dQuantity DESC;"""
